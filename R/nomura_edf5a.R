#################################
## Title: Extended Data Figure 5 panel a in Nomura et al - heatmap of pathway-based meta-programs
## Date: 2025.02.24
## Author: Avishay Spitzer
## Description: Produce a heatmap of pathway-based meta-programs
#################################
