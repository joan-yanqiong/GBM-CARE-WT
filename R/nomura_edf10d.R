#################################
## Title: Extended Data Figure 10 panel d in Nomura et al - layers heatmap of samples not classified to ecosystems
## Date: 2025.02.24
## Author: Avishay Spitzer
## Description: Generate a layers heatmap of samples not classified to ecosystems
#################################
