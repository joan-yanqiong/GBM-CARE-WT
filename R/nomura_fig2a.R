#################################
## Title: Figure 2 panel a in Nomura et al - heatmap of meta-programs
## Date: 2025.02.24
## Author: Avishay Spitzer
## Description: Produce a heatmap of meta-programs excluding the ones reflecting technical variability
#################################
